		...
		"payload_events": {
			'DATA_DATA': {
				...
				"paths": [
					...
					{"count": 3, "matches": {"0": "planets", "2": "sites"}, "req_admin": false, 'action': 'send_payload', 'suburl': "/planet/sites"}, // PLANET_SITES
					{"count": 2, "matches": {"0": "stations"}, "req_admin": false, 'action': 'send_payload', 'suburl': "/exchange/station"}, // STATION_DATA
					{"count": 1, "matches": {"0": "commodityexchanges"}, "req_admin": true, 'action': 'send_payload', 'suburl': "/global/comexexchanges"}, // COMEX_EXCHANGE_LIST
					// TODO: Validate that this entry for INFRASTRUCTURE PROJECTS is correct.
					{"count": 2, "matches": {"0": "projects"}, "req_admin": false, 'action': 'send_payload', 'suburl': "/infrastructure/project"}, // INFRASTRUCTURE_PROJECTS_DATA
					{"count": 2, "matches": {"0": "populations"}, "req_admin": false, 'action': 'send_payload', 'suburl': "/infrastructure"}, // INFRASTRUCTURE_DATA_DATA
					{"count": 2, "matches": {"0": "admincenters"}, "req_admin": false, 'action': 'send_payload', 'suburl': "/infrastructure/programs"}, // INFRASTRUCTURE_PROGRAMS_DATA
					{"count": 3, "matches": {"2": "ads"}, "req_admin": false, 'action': 'send_payload', 'suburl': "/localmarket"}, // LOCAL_MARKET_DATA_DATA
					{"count": 4, "matches": {"2": "cogc"}, "req_admin": false, 'action': 'send_payload', 'suburl': "/planet/cogc"}, // PLANET_COGC_DATA
					{"count": 2, "matches": {"0": "systems"}, "req_admin": false, 'action': 'send_payload', 'suburl': "/systemstars/star"}, // STAR_DATA
					{"count": 2, "matches": {"0": "users"}, "req_admin": false, 'action': 'send_payload', 'suburl': "/user/users"}, // USER_DATA_USERS
					{"count": 2, "matches": {"0": "companies"}, "req_admin": false, 'action': 'send_payload', 'suburl': "/user/companies"}, // USER_DATA_COMPANIES
					{"count": 3, "matches": {"0": "companies", "2": "offices"}, "req_admin": false, 'action': 'send_payload', 'suburl': "/user/offices"}, // USER_DATA_OFFICES
				]
			},
			'COMPANY_DATA': {
				'action': 'send_payload',

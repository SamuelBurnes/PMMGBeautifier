...
/* harmony export (immutable) */ __webpack_exports__["z"] = toFixed;
...
function CategorySort(a, b) {
    if (__WEBPACK_IMPORTED_MODULE_1__GameProperties__["c" /* MaterialNames */][a] == undefined || __WEBPACK_IMPORTED_MODULE_1__GameProperties__["c" /* MaterialNames */][b] == undefined) {
        return 0;
    }
...
function createMaterialElement(ticker, className = "prun-remove-js", amount = "none", text = false, small = false) {
    if (__WEBPACK_IMPORTED_MODULE_1__GameProperties__["c" /* MaterialNames */][ticker] == undefined && ticker != "SHPT") {
        return null;
    }
    ...
    run() {
        ...
        for (let i = 0; i < elements.length; i++) {
            ...
            if (matches && matches.length > 3) {
                ...
                const perItem = Object(__WEBPACK_IMPORTED_MODULE_1__util__["z" /* toFixed */])(totalCents / count / 100, 2);
        ...
        tables.forEach(table => {
            ...
            if (totalTime > 0) {
                rows.forEach(row => {
                    ...
                    const percent = Object(__WEBPACK_IMPORTED_MODULE_1__util__["z" /* toFixed */])(eta / totalTime * 100, 2);

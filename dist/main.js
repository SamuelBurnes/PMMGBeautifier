...
function createTable(tile, headers, sectionHeaderTitle = null) {
...
function Contracts_post(tile, parameters, jsondata) {
    ...
    const buyTable = Object(__WEBPACK_IMPORTED_MODULE_0__util__["g" /* createTable */])(tile, ["Material", "Name", "Partner", "Fulfilled", "Provis.", "Paid", "Pick Up"], `Buying ${validContracts["shipping"].length}`);

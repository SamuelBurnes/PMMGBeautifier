...
/* harmony export (immutable) */ __webpack_exports__["A"] = targetedCleanup;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__HeaderMinimizer__ = __webpack_require__(39);
...
function createCheckboxRow(label, enabled = false) {
    const inputRow = document.createElement("div");
    inputRow.classList.add(...__WEBPACK_IMPORTED_MODULE_1__Style__["e" /* Style */].FormRow);
    const inputLabel = document.createElement("label");
    inputLabel.textContent = label;
        ...
        buffers.forEach(buffer => {
            ...
            if (!inventory.classList.contains("pb-monitored")) {
                ...
                let onMutationsObserved = function () {
                    ...
                    Object(__WEBPACK_IMPORTED_MODULE_0__util__["A" /* targetedCleanup */])(tag, inventory);
        ...
        if (sortingDetails[4]) {
            ...
            materialsToSort.forEach(ticker => {
                if (!materialListContains(materials, ticker)) {
                    ...
                    if (matQuantityElem) {
                        matQuantityElem.style.color = "#bb0000";
                    }
...
class HeaderMinimizer {
    ...
    run() {
        var buffers = Object(__WEBPACK_IMPORTED_MODULE_0__util__["s" /* getBuffers */])("CX ");
        if (!buffers) {
            return;
        }
        buffers.forEach(buffer => {
        ...
        var buffers = Object(__WEBPACK_IMPORTED_MODULE_0__util__["s" /* getBuffers */])("CONT ");
        if (!buffers) {
            return;
        }
        buffers.forEach(buffer => {

...
function generateCheckTable(result, tile) // Create a list of all checklists
{
    ...
    checklistList.forEach(
        ...
        { // Should sort by duedate at some point...
            ...
            incompleteElem.appendChild(createTextSpan(incomplete.toLocaleString(undefined, {
...
function addChecklistItem(params) {
    ...
    case "Resupply":
        ...
        Object.keys(burn).forEach(mat => {
            if (burn[mat].DailyAmount < 0) {
                ...
                child.name = amt.toLocaleString(undefined, {
                    maximumFractionDigits: 0
                }) + " [[m:" + mat + "]]";
    ...
    case "Repair":
        ...
        Object.keys(mats).forEach(mat => {
            ...
            child.name = mats[mat].toLocaleString(undefined, {
                maximumFractionDigits: 0
            }) + " [[m:" + mat + "]]";
            info.children.push(child);
        });
    ...
    constructor(checkInfo, checklist, isChild ) {
        ...
        if (checkInfo.duedate) // The due date under the name
        {
            ...
            if (checkInfo.recurring) {
                dateText += " (every " + (checkInfo.recurring).toLocaleString(undefined, {
                    maximumFractionDigits: 1
                }) + " day" + (checkInfo.recurring == 1 ? ")" : "s)");
            }
